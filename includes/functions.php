...
function pmpro_update_posts_draft($level_id, $user_id) {
    $set_posts_to_draft = get_option('pmpro_set_posts_to_draft');
    if ($set_posts_to_draft) {
...
add_action('pmpro_after_change_membership_level', 'pmpro_update_posts_draft', 10, 2);
